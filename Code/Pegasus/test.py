...
with open("C:/Users/NLPmodels/Desktop/PythonNLP/Pegasus/summaries.txt", "r", encoding="utf-8") as file:
    summariesread = file.readlines()

 # Inputs to the model
inputs = tokenizer(summariesread, return_tensors="pt", padding=True, truncation=True)
